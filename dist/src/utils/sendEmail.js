...
exports.sendEmailVerificationEmail = exports.sendConfirmResetPasswordEmail = exports.sendResetPasswordEmail = exports.sendEmail = void 0;
...
const transporter = nodemailer_1.default.createTransport((0, nodemailer_sendgrid_transport_1.default)({
    auth: {
        api_key: custom_environment_variables_config_1.environmentConfig.SEND_GRID_API_KEY,
    },
}));
...
const sendEmail = (userEmail) => {
    const emailContent = {
        from: custom_environment_variables_config_1.environmentConfig?.ADMIN_SEND_GRID_EMAIL,
        to: userEmail,
...
const sendResetPasswordEmail = (userEmail, userName, link) => {
    htmlContent = `
<!DOCTYPE html>
<html lang="en-US">
  <head>
...
const sendConfirmResetPasswordEmail = (userEmail, userName, link) => {
    htmlContent = `
<!DOCTYPE html>
<html lang="en-US">
  <head>
...
const sendEmailVerificationEmail = (userEmail, userName, link) => {
    htmlContent = `
<!DOCTYPE html>
<html lang="en-US">
  <head>
...
exports.default = { sendEmailVerificationEmail: exports.sendEmailVerificationEmail, sendEmail: exports.sendEmail, sendResetPasswordEmail: exports.sendResetPasswordEmail, sendConfirmResetPasswordEmail: exports.sendConfirmResetPasswordEmail };
